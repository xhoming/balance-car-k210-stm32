...
void MPU6050_initialize(void) {
    ...
    MPU6050_setSleepEnabled(0); //进入工作状态 Enter working state
	  ...
	  MPU6050_setI2CBypassEnabled(0);	 //主控制器的I2C与	MPU6050的AUXI2C	直通关闭 I2C of the host controller and AUXI2C of MPU6050 are directly closed
}
...
{	   
	  ...
	  Temp=(I2C_ReadOneByte(devAddr,MPU6050_RA_TEMP_OUT_H)<<8)+I2C_ReadOneByte(devAddr,MPU6050_RA_TEMP_OUT_L);
		...
		Temp=(36.53+Temp/340)*10;	  //温度放大十倍存放 Temperature magnified ten times for storage
	  return (int)Temp;
}
//------------------End of File----------------------------
