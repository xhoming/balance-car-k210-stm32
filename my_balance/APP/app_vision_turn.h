...
typedef struct
{
    int16_t error;          /* road center error: -100..100 */
    int16_t slope;          /* road heading trend: -100..100 */
    uint8_t confidence;
    uint8_t base_speed;
...
extern float Vision_Heading_Kp;
extern float Vision_Crosstrack_Kp;
extern float Vision_Crosstrack_Gain;
extern float Vision_Speed_Soft;
extern float Vision_Turn_Kd;
extern float Vision_Gyro_Direction;
