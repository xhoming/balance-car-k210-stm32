 ...
 */
#define GOALKEEPER_LANE_ERROR_LIMIT              15
#define GOALKEEPER_TRIGGER_AREA_X10               15U /* 15表示全屏面积1.5%。 */
#define GOALKEEPER_TRIGGER_CONFIDENCE             35U /* 单帧触发的最低置信度。 */
#define GOALKEEPER_LANE_CONFIRM_FRAMES             1U /* 满足门槛后立即锁定。 */
#define GOALKEEPER_SIDE_TURN_TICKS               31U /* 原弧线距离的约2/3。 */
#define GOALKEEPER_SIDE_STRAIGHT_TICKS           12U /* 原直行距离的约2/3。 */
...
#define GOALKEEPER_DECEL_STEP                  0.80f /* 同步缩短减速滑行距离。 */
